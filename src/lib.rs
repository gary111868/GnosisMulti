// src/lib.rs
/*
 * Core library for GnosisMultiSig
 */
...
#[derive(Debug)]
pub struct GnosisMultiSigProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GnosisMultiSigProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GnosisMultiSig processing");
    
    let mut processor = GnosisMultiSigProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GnosisMultiSigProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GnosisMultiSigProcessor::new(false);
